...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
      function elimina(id_cliente){
			$.ajax({
			    type: "POST",
			    url: "controllers/eCliente.php",
			    data: "id_cliente="+id_cliente,
			    success: function(html){
			    if(html=='1'){
			    	bootbox.alert("Fue eliminado correctamente", function() {
                		document.location="iCliente.php";
                	        });
			    }
			    else{
...
alert("aqui");
		$("#ingresar").click(function(){ 
			...
			descripcion=$("#descripcion").val();
			 ...
			 $.ajax({
			    type: "POST",
			    url: "controllers/iCliente.php",
			    data: "id_cliente="+id_cliente+"&nombre="+nombre+"&descripcion="+descripcion,
			    success: function(html){ 
alert(html+"info");
			    if(html=='1'){
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="id_cliente" placeholder="Código del cliente" required />
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="descripcion" placeholder="Descripcion del cliente" required />
    </div>
  </div>
  <div class="form-group">
